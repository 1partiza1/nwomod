...
country = {
	...
	GREATNESS_DAYS = 1800, 	   -- how many days until country risks losing status as great nation
	BADBOY_LIMIT = 25,
...
economy = {
	...
	BANKRUPTCY_EXTERNAL_LOAN_YEARS	= 2,
	BANKRUPTCY_FACTOR = 0.02,
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 150000,
	MAX_LOAN_CAP_FROM_BANKS = 900, -- can loan max % of country tax base from single country
...
pops = {
	...
	BASE_GOODS_DEMAND = 1,
	BASE_POPGROWTH = 0.0, -- 0.0001 TODO
...
graphics =
{
	...
	CITIES_SIZE_MAX_POPULATION_K = 8000 -- TODO			-- When province population reach 1mln, the city will get it's maximum size.
}
